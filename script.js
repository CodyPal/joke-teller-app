...
// Disable/Enable Button depending on whether audio is playing.
...
function tellMe(joke){
    console.log(`this was the joke:`, joke);
    VoiceRSS.speech({
        key: '75ba68a80e9a4b59ad55c07914bb6da8',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
...
async function getJokes(){
    ...
    try{
        ...
        console.log(`could not get any jokes :( try again)`, err)
    }
}
